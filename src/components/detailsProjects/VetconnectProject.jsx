...
export default function VetconnectProject() {
    ...
    return (
        ...
        >
            <div className="max-w-6xl mx-auto">
                ...
                {/* Encabezado */}
                <div className="mb-12">
                    <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-4">VetConnect</h1>
                    <p className="text-xl text-gray-300 max-w-3xl">
                        Sistema completo de gestión veterinaria con historias clínicas digitales y módulo administrativo integrado.
                    </p>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-10 items-start">
                    ...
                    <div className="space-y-6">
                        {/* Imagen principal */}
                        <img
                            src="/images/projects-img/vetconnect/img-1.svg"
                            alt="Dashboard VetConnect"
                            className="w-full rounded-xl shadow-2xl border border-purple-500/20 cursor-pointer"
                            onClick={() => handleImageClick("/images/projects-img/vetconnect/img-1.svg")}
                        />
                        ...
                        >
                            ...
                            <div
                                ...
                                style={{ gridArea: "img1" }}
                                onClick={() => handleImageClick("/images/projects-img/vetconnect/img4-v.svg")}
                            >
                                <img
                                    src="/images/projects-img/vetconnect/img4-v.svg"
                                    alt="Versión móvil"
                            ...
                            <div
                                className="rounded-xl shadow-lg border border-purple-500/10 overflow-hidden flex items-center justify-center cursor-pointer"
                                style={{ gridArea: "img2" }}
                                onClick={() => handleImageClick("/images/projects-img/vetconnect/img-2.png")}
                            >
                                <img
                                    src="/images/projects-img/vetconnect/img-2.png"
                            ...
                            <div
                                className="rounded-xl shadow-lg border border-purple-500/10 overflow-hidden flex items-center justify-center cursor-pointer"
                                style={{ gridArea: "img3" }}
                                onClick={() => handleImageClick("/images/projects-img/vetconnect/img-3-w.svg")}
                            >
                                <img
                                    src="/images/projects-img/vetconnect/img3-w.svg"
                                    alt="Historial clínico"
                                    className="w-full h-auto"
                                />
                            </div>
                    ...
                    <div>
                        <div className="mb-10">
                            ...
                            <div className="space-y-4 text-gray-300 text-xl">
                                ...
                                <p>
                                    La aplicación facilita la gestión de citas, el mantenimiento de historiales médicos detallados, la administración de clientes y mascotas,
                                    y el acceso a un panel de control dinámico con estadísticas clave para la toma de decisiones.
                                </p>
                                <p>
                                    Con una interfaz intuitiva y herramientas avanzadas, VetConnect optimiza la eficiencia operativa y potencia la calidad del servicio veterinario.
                                </p>
                                <ul className="list-disc pl-6 space-y-2">
                                    <li>Coordinación perfecta de citas</li>
                                    <li>Historiales médicos detallados</li>
                                    <li>Gestión integral de clientes y mascotas</li>
                                    <li>Panel de control dinámico con estadísticas clave</li>
                                    <li>Interfaz intuitiva para una mejor experiencia de usuario</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div className="mb-10">
                            <div className="p-4 bg-gray-800/50 border border-gray-700/30 rounded-xl w-full">
                                ...
                                <div className="flex flex-wrap justify-center gap-2">
                                    {[
                                        'Angular 17', 'Angular Material', 'CoreUI', 'Bootstrap', 'FontAwesome',
                                        'RxJS', 'SweetAlert2', 'Moment.js', 'Chart.js', 'NgRx', 'PrimeNG', 'Tailwind CSS', 'API REST'
                                    ].map((tech, i) => (
                                        <motion.div
                                            key={tech}
